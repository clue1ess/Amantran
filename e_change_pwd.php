	...
	<body>
        ...
        <center>
            <h1><font color="white" size="8">Password Update<br><br></h1></font>
                <form id="tab" action="e_change_pwd.php" method = "POST">
                    <div class="container">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-primary"><a style="text-decoration:none" href="ee_info.php"><font color="white">Back</font></a></button><br><br> 
                        <?php
