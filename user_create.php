...
//echo "jdjjjjjjjjjjjjjjjjjjjjj";
    if(isset($_POST['add'])) {
        ...
        if(!preg_match("/^[a-zA-Z ]*$/",$fname )) {
            ...
            $pwderr = "";  
            //echo "jdc";    
            $q = "insert into customer values (\"NULL\", \"$fname\", \"$lname\", \"$email\", \"$phone\", \"$pwd1\", \"$street\", \"$city\", \"$state\")";
            $r = $conn->query($q);
            //var_dump($r);
            if($r) {
...
<html>
	...
	<body>
        ...
        <center>
     <h1><font color="white" size="8">Profile Details</font></h1>
           
                <form id="tab" action="user_create.php" method = "POST">
                <div class="container"> 
                   ...
                   <br> <?php echo "<font color=\"red\" size=\"4\">".$emailerr."</font>";?><br>
                    ...
                    <div>
                        <button class="btn btn-primary" name ="add">Create Account</button>
                        
                        <button type="button" class="btn btn-primary"><a style="text-decoration:none" href="user_login.php"><font color="white">Back to login</font></a></button>                        
                    </div>
                    <?php
                        echo "<font color=\"white\">".$msg;
                    ?>
                </form>
</div></div></center>
    </body>     
