	...
	<body>
        ...
        <center>
            <h1><font color="white" size="8">Profile Details<br><br></h1></font>
                <form id="tab" action="ee_info.php" method = "POST">
                    <div class="container">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-primary"><a style="text-decoration:none" href="e_change_pwd.php"><font color="white">Change Password</font></a></button>
                        <button type="button" class="btn btn-primary"><a style="text-decoration:none" href="employee_login.php"><font color="white">Logout</font></a></button><br><br>
                         <button type="button" class="btn btn-primary"><a style="text-decoration:none" href="em_info.php"><font color="white">Back</a></font></button>                        
